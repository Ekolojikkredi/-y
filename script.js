document.addEventListener("DOMContentLoaded", function() {
    ...
    const validPassword = "admin123"; // Doğru şifre
    let isAuthenticated = false; // Kullanıcı şifresi doğrulandı mı?
    ...
    viewDataBtn.addEventListener("click", function() {
        content.innerHTML = `
            ...
            <p>Şifre ile giriş yapmanız gerekiyor.</p>
            <form id="loginForm">
        ...
        loginForm.addEventListener("submit", function(e) {
            ...
            if (password === validPassword) {
                ...
                // Veri görüntüleme için sayfayı güncelle
                content.innerHTML = `
                    <h2>Veri Görüntüle</h2>
